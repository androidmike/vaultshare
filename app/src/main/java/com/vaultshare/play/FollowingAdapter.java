...
public class FollowingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FollowingAdapter(Context context, List<FirebaseModel> stations) {
...
//        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        View name = holder.itemView.findViewById(R.id.text);
...
//            flashRec(rec);
        ...
        if (name != null) {
            ...
            int dropRes = R.raw.dj_drop_dont_hate;
            switch (r) {
                case 0:
                    dropRes = R.raw.dj_drop_dont_hate;
                    break;
                case 1:
                    dropRes = R.raw.dj_drop_paul;
                    break;
                case 2:
                    dropRes = R.raw.dj_drop_derek_for_real;
                    break;
                default:
                    dropRes = R.raw.dj_drop_3_15;

            }
            final int finalDropRes = dropRes;
            name.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
                        ...
                        mPlayer = MediaPlayer.create(context, finalDropRes);
                        mPlayer.start();
