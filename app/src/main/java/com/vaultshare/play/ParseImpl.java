...
public class ParseImpl {
    ...
    private static String ParseAppID     = "F7OaoWjVFTky1K1Rd6Mx90qKuxUb4Judm9pjXEuT";
    private static String ParseClientKey = "DlD9YMoOpbNY2AaiMqPOuA53vp1JXh13ItaLumnd";
