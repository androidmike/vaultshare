...
public class ExampleDataProvider extends AbstractDataProvider {
    private List<ConcreteData> mData = new ArrayList<>();
    private ConcreteData mLastRemovedData;
    private int mLastRemovedPosition = -1;

    public ExampleDataProvider(List<ConcreteData> concreteData) {
        this.mData = concreteData;
    }
    ...
    public static final class ConcreteData extends Data {
        ...
        ConcreteData(long id, String trackId, int viewType, String text, int swipeReaction) {
            mId = id;
            mViewType = viewType;
